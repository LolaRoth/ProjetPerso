...
<template>
  <div class="relative h-48 rounded-2xl bg-zinc-900/50 border border-zinc-800 overflow-hidden">
    <div class="absolute top-4 left-4">
      <h3 class="text-lg font-bricolage text-white">🎯 Le Bouton Insaisissable</h3>
    ...
    <button
      class="absolute px-4 py-2 rounded-lg font-bricolage font-bold text-black
             transition-all duration-150 ease-out transform hover:scale-110"
